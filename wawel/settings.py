...
EMAIL_HOST_USER = 'wawel.boulangerie@gmail.com'  # Remplace par l'adresse email WAWEL
EMAIL_HOST_PASSWORD = 'hibg kvvn ntxx ynyi'  # Mot de passe spécifique généré
DEFAULT_FROM_EMAIL = 'WAWEL <wawel.boulangerie@gmail.com>'  # Nom affiché pour l'expéditeur
